...
<section class="text-white flex items-center gap-4">
...
<nav class="flex flex-col gap-2 font-roboto h-full">
    ...
    <a href="/admin/funciones" class="flex items-center gap-3 text-gray-400 px-4 py-2 hover:bg-gray-800 hover:text-white rounded transition">
...
@section('content')
<section class="bg-cinecard p-8 rounded-lg shadow-lg border border-gray-800">
    
    <header class="mb-8">
        <h2 class="text-3xl font-montserrat font-bold text-white mb-2">Resumen del Sistema</h2>
        <p class="text-gray-400 font-roboto text-lg">Selecciona un módulo en el menú lateral para gestionar los registros.</p>
    </header>

    <section class="grid grid-cols-1 md:grid-cols-3 gap-6">
        
        <article class="bg-[#0B0F19] p-6 rounded-lg border-l-4 border-cinecyan shadow flex items-center justify-between">
            <section>
        ...
        <article class="bg-[#0B0F19] p-6 rounded-lg border-l-4 border-cinemagenta shadow flex items-center justify-between">
            <section>
        ...
        <article class="bg-[#0B0F19] p-6 rounded-lg border-l-4 border-green-500 shadow flex items-center justify-between">
            <section>
